...
use App\Http\Middleware\CekWaktuUjian;
...
Route::middleware(StorageMiddleware::class)->group(function () {
    ...
    Route::middleware(['auth', RoleMiddleware::class . ':siswa'])->group(function () {
        Route::get('/dashboard/siswa', SiswaDashboard::class)->name('siswa.dashboard');
        ...
        Route::get('/dashboard/siswa/ujian/{ujian}/mulai-ujian', UjianMulai::class)->middleware([CekWaktuUjian::class])->name('ujian.mulai');
